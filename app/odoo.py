...
def create_quotation_from_xlsx_data(
    ...
    for line in lines:
        ...
        if product_id:
            ...
            if product_code:
                ...
                logger.warning(f"Product '{product_code}' not found in Odoo - creating description line")
            else:
    ...
    logger.info(f"Quotation created successfully: {products_found} product lines, {products_not_found} description lines")
    return order_id
